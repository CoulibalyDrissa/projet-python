...
buttmodifier= customtkinter.CTkButton(master=root,text="Reservation",height=30,width=40,border_width=1,corner_radius=20,fg_color="#FFFFFF",command=reservation)
